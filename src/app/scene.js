...
import { loadPresetWithTextures, preloadFruitTextures, preloadLeafTextures } from './textures';
...
export async function createScene(renderer) {
  ...
  const tree = new Tree();
  await preloadLeafTextures();
  await preloadFruitTextures();
  ...
  async function createTree() {
    ...
    await loadPresetWithTextures(t, presets[index]);
